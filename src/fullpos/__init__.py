...
_OBJECT_EXPORTS = {
    ...
    "land_sea_mask_to_grid": ("fullpos.masks", "land_sea_mask_to_grid"),
    ...
    "masked_surface_interpolate": ("fullpos.masks", "masked_surface_interpolate"),
    ...
    "spectral_interpolate": ("fullpos.api", "spectral_interpolate"),
    "spectral_interpolate_values": ("fullpos.api", "spectral_interpolate_values"),
    "spectral_regrid": ("fullpos.api", "spectral_regrid"),
